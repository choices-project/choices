...
/**
 * Insert Mock Data for Automated Polls
 * 
...
async function insertMockData() {
  ...
  try {
    ...
    const { data: tables, error: tablesError } = await supabase
      ...
      .in('table_name', ['trending_topics', 'generated_polls', 'data_sources']);
    ...
    // Insert trending topics (simplified)
    console.log('\n📊 Inserting trending topics...');
