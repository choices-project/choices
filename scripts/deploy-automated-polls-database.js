...
/**
 * Deploy Automated Polls Database Schema
 * 
 * This script deploys the automated polls database schema to Supabase
 * including all tables, indexes, triggers, and initial data.
 */
...
async function deployDatabase() {
  console.log('🚀 Deploying Automated Polls Database Schema...\n');

  try {
    // Read the schema file
    const schemaPath = path.join(__dirname, '../database/automated_polls_schema.sql');
