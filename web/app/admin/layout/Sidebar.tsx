            ...
            <div className="bg-gray-50 rounded-lg p-4">
              ...
              <div className="space-y-2 text-sm text-gray-600">
                <div className="flex justify-between">
                  <span>Topics:</span>
                  <span className="font-medium">{metrics?.totaltopics || 0}</span>
                </div>
                <div className="flex justify-between">
                  <span>Polls:</span>
                  <span className="font-medium">{metrics?.totalpolls || 0}</span>
                </div>
                <div className="flex justify-between">
                  <span>Active:</span>
                  <span className="font-medium">{metrics?.activepolls || 0}</span>
                </div>
              </div>
            </div>
          </div>
