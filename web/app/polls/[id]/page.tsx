...
import { Loader2, ArrowLeft, Share2, Copy, CheckCircle, AlertCircle } from 'lucide-react';
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        {(poll.status === 'closed' || poll.status === 'locked' || poll.status === 'post-close') && (
          <PostCloseBanner
            ...
            baselineAt={poll.baselineAt ? new Date(poll.baselineAt) : undefined}
            lockedAt={poll.lockedAt ? new Date(poll.lockedAt) : undefined}
            allowPostClose={poll.allowPostClose}
            className="mb-6"
          />
        )}
