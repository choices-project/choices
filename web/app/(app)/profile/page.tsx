...
export default function ProfilePage() {
  ...
  // Profile content (only shown if authenticated)
  let profileData: any = null;
  let profileLoading = false;
  let error: any = null;
  let isAnyUpdating = false;
  let profileError: any = null;
  let exportMutation: any = { mutate: () => {}, isPending: false };
  ...
  try {
    ...
    isAnyUpdating = loadingStates.isAnyUpdating;
    profileError = errorStates.profileError;
    exportMutation = exportHook;
  } catch (hookError) {
    console.warn('Profile hooks failed, using fallbacks:', hookError);
    // Use fallback values
  }
