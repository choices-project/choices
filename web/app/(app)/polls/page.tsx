...
let useHashtagStore: any;
let useHashtagActions: any;
let useHashtagStats: any;

try {
  const fullStore = require('@/lib/stores');
  useHashtagStore = fullStore.useHashtagStore;
  useHashtagActions = fullStore.useHashtagActions;
  useHashtagStats = fullStore.useHashtagStats;
} catch (error) {
  console.warn('Full hashtag store not available, using minimal store:', error);
  const minimalStore = require('@/lib/stores/hashtagStoreMinimal');
  useHashtagStore = minimalStore.useHashtagStore;
  useHashtagActions = minimalStore.useHashtagActions;
  useHashtagStats = minimalStore.useHashtagStats;
}

// Enhanced poll interface with hashtag integration
interface EnhancedPoll {
  id: string;
  title: string;
  description: string;
  status: string;
