      ...
      <div className="max-w-2xl mx-auto">
        ...
        {process.env.NODE_ENV === 'development' && (
          <details className="mt-4 text-sm text-muted-foreground">
            <summary className="cursor-pointer font-medium hover:text-foreground focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 dark:focus:ring-offset-gray-900 rounded">
              Error Details (Development Only)
            </summary>
            <pre className="mt-2 p-3 bg-muted text-foreground rounded overflow-auto text-xs">
              {error.message}
              {error.digest && `\nDigest: ${error.digest}`}
            </pre>
          </details>
