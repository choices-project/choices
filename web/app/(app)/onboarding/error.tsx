        ...
        <div className="bg-red-50 dark:bg-red-900/30 border border-red-200 dark:border-red-800 rounded-lg p-6">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1 text-left">
              <h2 className="text-xl font-semibold text-red-900 dark:text-red-300 mb-2">Something went wrong</h2>
              <p className="text-red-700 dark:text-red-300 mb-4">Failed to load onboarding flow. Please try again.</p>
