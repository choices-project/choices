...
export default function ResetPasswordConfirmPage() {
  ...
  if (isSuccess) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 flex items-center justify-center py-12 px-4">
        <div className="max-w-md w-full space-y-4 text-center">
          <h1 className="text-2xl font-semibold text-gray-900">{t('auth.reset.confirm.successTitle')}</h1>
          <p className="text-sm text-gray-600">{t('auth.reset.confirm.successBody')}</p>
          <button
            type="button"
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-6">
        <div className="text-center">
          <h1 className="text-3xl font-bold text-gray-900">{t('auth.reset.confirm.heading')}</h1>
          <p className="mt-2 text-sm text-gray-600">{t('auth.reset.confirm.subheading')}</p>
        </div>
