// Test with a federal representative
require('dotenv').config({ path: '.env.local' });

async function testFederalRep() {
  console.log('🧪 Testing with federal representative...');
  
  try {
    // Test with a federal representative (should work with Congress.gov)
    const testRep = {
