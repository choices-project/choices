...
class UpstashRateLimiter {
  ...
  async checkLimit(
    ...
    try {
      ...
      if (isE2E) {
        ...
        // Request is still allowed below; avoid ERROR-level noise in production observability.
        logger.warn(
  ...
  // Public wrapper to allow external callers to record violations with extra context
  public async recordViolationExternal(violation: ViolationData): Promise<void> {
