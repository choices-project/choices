...
export function transformOpenStatesLegislator(legislator: OpenStatesLegislator): Record<string, unknown> {
  try {
    logger.debug('Transforming Open States legislator', { 
      id: legislator.id, 
    ...
    logger.debug('Open States legislator transformed successfully', { 
      id: transformed.id 
    });
    ...
    logger.error('Failed to transform Open States legislator', { 
      id: legislator.id, 
      error 
    });
...
export function transformOpenStatesBill(bill: OpenStatesBill): Record<string, unknown> {
  try {
    logger.debug('Transforming Open States bill', { 
      id: bill.id, 
    ...
    logger.debug('Open States bill transformed successfully', { 
      id: transformed.id 
    });
    ...
    logger.error('Failed to transform Open States bill', { 
      id: bill.id, 
      error 
    });
...
export function transformOpenStatesVote(vote: OpenStatesVote): Record<string, unknown> {
  try {
    logger.debug('Transforming Open States vote', { 
      id: vote.id, 
    ...
    logger.debug('Open States vote transformed successfully', { 
      id: transformed.id 
    });
    ...
    logger.error('Failed to transform Open States vote', { 
      id: vote.id, 
      error 
    });
...
export function transformToCandidateCard(legislator: OpenStatesLegislator): Record<string, unknown> {
  try {
    logger.debug('Transforming Open States legislator to candidate card', { 
      id: legislator.id 
    });
    ...
    logger.debug('Open States candidate card transformed successfully', { 
      id: transformed.id 
    });
    ...
    logger.error('Failed to transform Open States legislator to candidate card', { 
      id: legislator.id, 
      error 
    });
