...
export async function POST(request: NextRequest) {
  try {
    ...
    if (credential) {
      // Log registration verification attempt for audit trail
      console.log(`Passkey registration verification for user: ${username}${displayName ? ` (${displayName})` : ''}, userId: ${userId}, challenge: ${challenge}`);
