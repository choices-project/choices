...
export function HashtagManagement({
  ...
  const [hashtagToDelete, setHashtagToDelete] = useState<string | null>(null);
  ...
  const handleDeleteClick = (hashtagId: string) => {
    setHashtagToDelete(hashtagId);
    setShowDeleteConfirm(true);
  };

  const handleDeleteConfirm = () => {
    if (hashtagToDelete) {
      void handleDeleteHashtag(hashtagToDelete);
    }
  };
  ...
  return (
    <div className={`hashtag-management ${className}`}>
      <AlertDialog open={showDeleteConfirm} onOpenChange={(open) => { setShowDeleteConfirm(open); if (!open) setHashtagToDelete(null); }}>
        <AlertDialogContent>
          <AlertDialogHeader>
      ...
      {/* Header */}
        ...
        <div>
                <h2 className="text-xl font-semibold text-foreground">Hashtag Management</h2>
                <p className="text-sm text-muted-foreground">Manage and organize hashtags</p>
              </div>
            </div>
            <button
        ...
        <div className="flex flex-col sm:flex-row gap-4">
            ...
            <div className="flex items-center space-x-2">
              ...
              <select
                ...
                className="px-3 py-2 border border-border rounded-lg focus:ring-2 focus:ring-ring focus:border-primary"
              >
        ...
        {showCreateForm && (
          <div className="p-6 border-b border-border bg-muted">
            <h3 className="text-lg font-medium text-foreground mb-4">Create New Hashtag</h3>
          ...
          {isLoading ? (
            ...
            <div className="space-y-4">
              {filteredHashtags.map(hashtag => (
                <div key={hashtag.id} className="flex items-center justify-between p-4 border border-border rounded-lg hover:bg-muted">
                  <div className="flex items-center space-x-3">
                    <div className="p-2 bg-blue-100 rounded-lg">
                      ...
                      <p className="text-sm text-muted-foreground">{hashtag.display_name}</p>
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <button
                      ...
                      className="px-3 py-1 text-primary hover:text-primary/80 text-sm transition-colors"
                    >
                      Edit
                    </button>
                    <button
