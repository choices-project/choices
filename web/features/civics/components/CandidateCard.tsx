          ...
          <div className="flex items-start justify-between">
            ...
            <div className="flex flex-col space-y-2 ml-4">
              ...
              <button
                ...
                className="p-2 rounded-full text-gray-400 hover:text-green-500 hover:bg-green-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                aria-label="Send Message"
                title={!user ? 'Please log in to send messages' : 'Send a message to this representative'}
              >
