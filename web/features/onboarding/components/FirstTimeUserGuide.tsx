 ...
 * 
 * Post-onboarding guide for new users:
 * - Key actions: try a poll, find representatives, explore campaign finance
 * - Progress tracking for completed actions
 * - "Get Started" button when all actions are completed
 * 
 * Features:
 * - Action tracking and completion status
 * - Interactive guide with clear next steps
 * - Responsive design
 * - Modal overlay with close functionality
 * 
 * @param {FirstTimeUserGuideProps} props - Component props
 * @returns {JSX.Element} First-time user guide interface
 */
