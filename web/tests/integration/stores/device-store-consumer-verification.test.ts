...
describe('Device Store Consumer Verification', () => {
  it('exposes selector hooks for device state', () => {
    ...
    expect(typeof useNetworkInfo).toBe('function');
  });
  ...
  it('provides action hooks for device management', () => {
    ...
    expect(typeof actions.updateScreenSize).toBe('function');
    expect(typeof actions.updateCapabilities).toBe('function');
    expect(typeof actions.updateNetworkInfo).toBe('function');
  });
