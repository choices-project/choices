...
test.describe('Production Expanded Tests', () => {
  ...
  test.describe('Page Navigation', () => {
    test('can navigate from feed to auth', async ({ page }) => {
    ...
    test('can navigate from auth back to feed', async ({ page }) => {
      await page.goto(`${BASE_URL}/auth`, { waitUntil: 'domcontentloaded', timeout: 30_000 });
    ...
    test('root redirect works consistently', async ({ page }) => {
  ...
  test.describe('Performance Metrics', () => {
    test('root page redirect is fast', async ({ page }) => {
    ...
    test('feed page time to interactive is acceptable', async ({ page }) => {
      ...
      // Wait for page to be interactive (no blocking scripts)
