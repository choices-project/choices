...
test.describe('Feedback Widget', () => {
  ...
  test('feedback widget button appears on page', async ({ page }) => {
    // Widget button should be visible (fixed position bottom-right)
    await expect(page.locator('.fixed.bottom-6.right-6')).toBeVisible({ timeout: 10000 });
  });
  ...
  test('opens feedback modal when clicked', async ({ page }) => {
    ...
    // Modal should open with "Enhanced Feedback" title
