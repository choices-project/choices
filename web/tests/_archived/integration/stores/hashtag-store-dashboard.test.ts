...
const mockHashtagService = {
  getTrendingHashtags: jest.fn<(...args: any[]) => Promise<any>>(),
  searchHashtags: jest.fn<(...args: any[]) => Promise<any>>(),
  followHashtag: jest.fn<(...args: any[]) => Promise<any>>(),
  getUserHashtags: jest.fn<(...args: any[]) => Promise<any>>(),
};
