...
jest.mock('@/hooks/useI18n', () => ({
  useI18n: () => {
    const translations: Record<string, (params?: Record<string, any>) => string> = {
      ...
      'civics.lure.live.locationUpdated': ({ location } = {}) =>
        `Civic insights updated for ${location}.`,
      ...
      'civics.lure.candidates.dataQualityBadge': ({ value } = {}) =>
        `${value as string}% data quality`,
      ...
      'civics.lure.candidates.activity.lastUpdate': ({ date } = {}) =>
        `Last update on ${date as string}`,
