...
const createMockFeedItem = (overrides: Partial<FeedItemData> = {}): FeedItemData => ({
  id: 'feed-1',
  ...
  representativeOffice: 'Senator',
  representativePhoto: 'https://example.com/photo.jpg',
...
describe('FeedItem RTL Integration Tests', () => {
  ...
  it('expands content when expand button is clicked', async () => {
    const user = userEvent.setup();
    const feedItem = createMockFeedItem({
      description: 'This is a longer description that might be truncated...',
    });
