...
describe('AdminDashboard', () => {
  ...
  const mockedStores = jest.requireMock('@/lib/stores') as {
    useAdminActiveTab: jest.Mock;
    useAdminDashboardStats: jest.Mock;
    useAdminDashboardActions: jest.Mock;
    useAdminLoading: jest.Mock;
    useAdminError: jest.Mock;
    useAdminStats: jest.Mock;
    useAdminNotifications: jest.Mock;
    useTrendingTopics: jest.Mock;
    useRecentActivity: jest.Mock;
    useHashtagActions: jest.Mock;
    useHashtagLoading: jest.Mock;
    useHashtagError: jest.Mock;
    useTrendingHashtags: jest.Mock;
  };
  const mockedFeedsStore = jest.requireMock('@/lib/stores/feedsStore') as {
    useFeedsActions: jest.Mock;
    useFeeds: jest.Mock;
    useFeedsLoading: jest.Mock;
    useFeedsError: jest.Mock;
  };
