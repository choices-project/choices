...
import type { CacheStrategyManager } from '@/lib/cache/cache-strategies';
...
describe('CacheInvalidationManager with Strategy Manager', () => {
  ...
  let mockStrategyManager: CacheStrategyManager;
  ...
  beforeEach(() => {
    ...
    } as unknown as CacheStrategyManager;
