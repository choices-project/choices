...
describe('PasskeyRegister', () => {
  const mockedBeginRegister = jest.mocked(beginRegister);
  ...
  it('shows success message when registration succeeds', async () => {
    mockedBeginRegister.mockResolvedValue({ success: true, data: {} });
  ...
  it('shows error message when registration fails', async () => {
    ...
    useUserStore.getState().resetBiometric();
    mockedBeginRegister.mockResolvedValue({ success: false, error: 'Registration failed' });
