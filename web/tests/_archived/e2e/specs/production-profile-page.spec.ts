...
test.describe('Production Profile Page Tests', () => {
  ...
  test('profile page navigation from global nav works', async ({ page }) => {
    ...
    console.log('Navigation test - Has Profile Content:', hasProfileContent);
    console.log('Navigation test - Spinner Visible:', spinnerVisible);
