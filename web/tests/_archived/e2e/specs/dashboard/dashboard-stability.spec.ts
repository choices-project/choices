        ...
        return {
          ...
          navigationItems: {
            feedLink: {
              ...
              visible: feedLink[0] ? (feedLink[0] as HTMLElement).offsetParent !== null : false,
              testId: feedLink[0]?.getAttribute('data-testid') ?? null,
            },
            pollsLink: {
              count: pollsLink.length,
              visible: pollsLink[0] ? (pollsLink[0] as HTMLElement).offsetParent !== null : false,
              testId: pollsLink[0]?.getAttribute('data-testid') ?? null,
            },
            dashboardLink: {
              count: dashboardLink.length,
              visible: dashboardLink[0] ? (dashboardLink[0] as HTMLElement).offsetParent !== null : false,
              testId: dashboardLink[0]?.getAttribute('data-testid') ?? null,
            },
            dashboardNavTestId: {
              count: dashboardNavTestId.length,
              visible: dashboardNavTestId[0]
                ? (dashboardNavTestId[0] as HTMLElement).offsetParent !== null
                : false,
            },
          },
          loadingStates: {
