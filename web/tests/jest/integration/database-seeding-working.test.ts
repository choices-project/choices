...
import { seedTestPolls, cleanupTestPolls } from '../helpers/seed-test-data-working';
...
describe('Database Seeding Integration - Working Version', () => {
  ...
  it('should seed test polls successfully using working approach', async () => {
