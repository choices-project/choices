...
export default function BurgerMenu({ isOpen, onClose, user }: BurgerMenuProps) {
  ...
  const renderMainMenu = () => (
    <div className="space-y-4">
      ...
      <div className="pt-4 border-t border-border">
        <button className="w-full flex items-center space-x-3 p-3 text-left hover:bg-muted rounded-lg transition-colors text-red-600">
      ...
      <div className="space-y-3">
        {contributionOptions.map((option) => (
          <button
            ...
            className="w-full p-4 border border-border rounded-lg hover:border-gray-300 dark:hover:border-gray-600 transition-colors text-left"
          >
  ...
  return (
    <>
      ...
      {/* Menu */}
      <div className="fixed right-0 top-0 h-full w-80 bg-background shadow-xl z-50 transform transition-transform">
