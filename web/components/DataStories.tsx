                  ...
                  <details className="group">
                    ...
                    <div className="mt-3 space-y-2 text-xs text-gray-600">
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium">{story.statistical_analysis.sample_size}</span>
                      </div>
                      <div className="flex justify-between">
                        <span>Margin of Error:</span>
                        <span className="font-medium">{story.statistical_analysis.margin_of_error}</span>
                      </div>
                      <div className="flex justify-between">
                        <span>Confidence Level:</span>
                        <span className="font-medium">{story.statistical_analysis.confidence_level}</span>
                      </div>
                      <div className="pt-2 border-t border-gray-200">
                        <p className="font-medium text-gray-700 mb-1">Key Finding:</p>
                        <p className="text-gray-600">{story.statistical_analysis.key_finding}</p>
                      </div>
                    </div>
                  </details>
                </div>
              ...
              <div className="px-6 py-4 bg-gray-50 border-t border-gray-100">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2 text-sm text-gray-500">
                    ...
                    <span>{story.data.reduce((sum: any, item: any) => sum + (item.sample_size || 0), 0).toLocaleString()} respondents</span>
                  </div>
                  <div className="flex items-center gap-2">
