...
import { useProfile, useProfileLoadingStates, useProfileErrorStates } from '@/lib/hooks/use-profile';
import { useExportData } from '@/lib/hooks/use-profile';
...
export default function ProfilePage() {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 space-y-6">
      ...
      {/* Privacy Settings */}
      {profile.privacy_settings && Object.keys(profile.privacy_settings).length > 0 && (
        <Card>
          <CardHeader>
