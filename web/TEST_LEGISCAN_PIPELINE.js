// Test LegiScan API through the pipeline
require('dotenv').config({ path: '.env.local' });

async function testLegiScanPipeline() {
  console.log('🧪 Testing LegiScan API through pipeline...');
  
  try {
    // Test with a state legislator (LegiScan is for state-level)
    const testRep = {
      name: "George Whitesides", // We know this exists
      state: "California",
