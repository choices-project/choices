// Test with an actual state legislator
require('dotenv').config({ path: '.env.local' });

async function testStateLegislator() {
  console.log('🧪 Testing with actual state legislator...');
  
  try {
    // Test with a state legislator (should work with OpenStates)
    const testRep = {
      name: "Anthony Rendon", // California Assembly Speaker - should have data
      state: "California",
