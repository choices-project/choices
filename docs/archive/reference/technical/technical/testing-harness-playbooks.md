...
- Widget modernization reference: see `docs/STATE_MANAGEMENT.md` for acceptance criteria that harmonise harness expectations, keyboard affordances, and analytics announcements.
