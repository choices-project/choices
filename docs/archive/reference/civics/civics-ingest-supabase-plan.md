...
| `civic_elections` | **New via `npm run state:sync:google-elections`** | No consumer yet; divisions must align with reps | Surface upcoming elections in web apps via division-scoped queries |
