...
6. **Documentation**
   - Agent setup: `docs/AGENT_SETUP.md` (skills, MCP, verification). `SUPABASE_AGENT_GUIDE.md` was removed; agents use Postgres/React skills and project guides.
   - Implementation summary (archived): `./AGENT_IMPLEMENTATION_SUMMARY.md`
...
docs/
├── AGENT_SETUP.md                  # Skills, MCP, verification (SUPABASE_AGENT_GUIDE removed)
...
- **Agent setup**: `docs/AGENT_SETUP.md` - Skills, MCP, verification. Use Postgres/React skills + project guides for patterns.
- **Implementation details (archived):** `./AGENT_IMPLEMENTATION_SUMMARY.md` in this folder. **Current agent setup:** `docs/AGENT_SETUP.md`
