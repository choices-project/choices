...
> **March 2026:** Dark mode is now implemented via design tokens (CSS custom properties) rather than per-element `dark:` variants. See `web/app/globals.css` for token definitions. Over 40 files migrated.
