...
/**
 * Insert Final Mock Data
 * 
 * This script inserts mock data with correct status values that match the constraints.
 */
...
async function insertFinalData() {
  console.log('🚀 Inserting Final Mock Data...\n');

  try {
    // Insert trending topics with correct status values
    ...
    console.log('\n🎉 Final data insertion completed successfully!');
    console.log('\n📊 Summary:');
    ...
    console.log('\n💡 The dashboard will now show real database data instead of mock data!');

  } catch (error) {
    console.error('❌ Final data insertion failed:', error);
    process.exit(1);
  }
}
