...
- [ ] **Contract & Harness Parity** — `npm run test:contracts` green; any new routes reflected in `docs/API/contracts.md` and regenerated [`docs/API/inventory.md`](API/inventory.md) (`npm run docs:api-inventory` from repo root); **`npm run verify:docs`** green; historical contract matrices live under `docs/archive/reference/testing/`. MSW fixtures updated.
