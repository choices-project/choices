...
begin
  ...
  set
    ...
    is_active = coalesce(s.is_active, rc.is_active),
    verification_status = coalesce(rc.verification_status, 'unverified'),
    updated_at = now()
...
comment on function public.sync_representatives_from_openstates() is
  'Merge staged OpenStates data into canonical representative tables.';
